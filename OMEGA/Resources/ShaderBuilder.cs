    ...
    public static class ShaderBuilder
    {
        ...
        public static ShaderBuildResult Build(string vs_src_path, string fs_src_path)
        {
            ...
            try
            {
                ...
                temp_vs_bin_output = Path.Combine(directory, "dx_" + Path.GetFileNameWithoutExtension(vs_src_path) + ".bin");
            ...
            try
            {
                ...
                temp_fs_bin_output = Path.Combine(directory, "dx_" + Path.GetFileNameWithoutExtension(fs_src_path) + ".bin");
