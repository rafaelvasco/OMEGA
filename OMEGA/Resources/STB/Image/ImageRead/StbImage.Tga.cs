namespace STB
{
    ...
    {
        public static int stbi__tga_get_comp(int bitsPerPixel, int isGrey, int* isRgb16)
        {
            if (isRgb16 != null)
                *isRgb16 = 0;
            switch (bitsPerPixel)
        ...
        public static void stbi__tga_read_rgb16(StbiContext s, byte* @out)
        {
